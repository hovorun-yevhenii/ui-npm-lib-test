...
svg {
  ...
  path {
    &:nth-of-type(1) {animation: color #{$duration}s #{$delay * 0}s $timing infinite alternate;}
    &:nth-of-type(2) {animation: color #{$duration}s #{$delay * 1}s $timing infinite alternate;}
    &:nth-of-type(3) {animation: color #{$duration}s #{$delay * 2}s $timing infinite alternate;}
    &:nth-of-type(4) {animation: color #{$duration}s #{$delay * 3}s $timing infinite alternate;}
    &:nth-of-type(5) {animation: color #{$duration}s #{$delay * 4}s $timing infinite alternate;}
  }
